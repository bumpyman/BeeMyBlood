...
(function(){
  ...
  function rDonneurs(){
    ...
    el.innerHTML = '<div class="grid-2-1"><div><div class="card">'+titre('Dossier donneur·se','purple-400',TABS[1].ico)
      + kpis([['Dossiers', E.donneurs.length, region().donors ? region().donors.toLocaleString('fr-CH')+' inscrit·e·s dans la région' : ''],['Actifs sur 12 mois', actifs, 'au moins un don'],['Aptes aujourd’hui', aptes, 'délai écoulé'],['Primo-donneurs revenus', (52+Math.floor(rng('pd'+cle())()*14))+' %', 'second don dans les 12 mois, à relancer : '+relance]])
