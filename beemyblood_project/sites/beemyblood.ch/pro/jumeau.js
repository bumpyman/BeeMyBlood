...
(function(){
  ...
  var EPISODES = {
    ...
    campagne: { nom:'Campagne ou appel', desc:'Afflux de dons pendant quelques jours. La simulation montre l’effet sur la péremption cinq à six semaines plus tard.', champs:[['debut','Début (jour)',30],['duree','Durée (jours)',7],['dons','Dons (%)',40],['demande','Demande (%)',0],['ajourn','Ajournements (+ points)',2]] },
  ...
  function vueScenario(){
    ...
    return '<div class="jm-grid"><div>'
      ...
      + '</div><div>'
      + '<div class="sidebar-card"><h4 style="font-weight:700;margin-bottom:.5rem">Événements à simuler</h4><p class="jm-muted" style="margin-bottom:.5rem">Cochez un ou plusieurs événements. Chacun modifie temporairement les dons, les commandes ou le laboratoire à partir du jour indiqué (le jour 0 est le premier jour mesuré). Les événements se cumulent.</p>'+episodes+'</div>'
