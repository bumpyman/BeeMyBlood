...
(function(){
  ...
  function vueComparaison(){
    ...
    var A=UI.ref, B=UI.variante, cadrage = (A.sc.horizon!==B.sc.horizon||A.sc.graine!==B.sc.graine||A.n!==B.n) ? '<p class="jm-muted" style="margin:.5rem 0;color:var(--amber-400)">Les deux simulations diffèrent par leur durée, leur numéro de tirage ou leur nombre de répétitions : une part des écarts vient du hasard.</p>' : '<p class="jm-muted" style="margin:.5rem 0">Même durée, même numéro de tirage, même nombre de répétitions : les écarts viennent uniquement des réglages et des événements.</p>';
    ...
    return head+cadrage+'<p class="jm-muted">Réglages qui diffèrent : '+(diff.length?diff.join(', '):'aucun')+'. Événements : '+h(epA)+' contre '+h(epB)+'.</p>'
