...
(function(){
  ...
  var css = '.bmba-wrap{position:fixed;inset:0;z-index:100050;background:#0a0a12;color:#f0ece2;display:flex;align-items:center;justify-content:center;padding:18px;font:15px/1.55 "DM Sans",system-ui,sans-serif;overflow:auto}'
    ...
    + '.bmba-user{position:fixed;left:12px;bottom:52px;z-index:100040;width:38px;height:38px;padding:0;border-radius:50%;justify-content:center;font-size:17px;font-family:"DM Sans",system-ui,sans-serif;color:#8b8b9e;background:rgba(18,18,30,.9);border:1px solid rgba(200,169,96,.2);display:flex;align-items:center;backdrop-filter:blur(8px);cursor:pointer;overflow:visible}.bmba-user span,.bmba-user a,.bmba-user button{display:none}.bmba-user::before{content:"👤"}body[data-bmba-ecran] .bmba-user{display:none}'
    ...
    + '@media(max-width:640px){.bmba-box{padding:22px 16px 18px;border-radius:14px}.bmba-user{left:54px}}';
